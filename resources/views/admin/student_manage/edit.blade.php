...
@section('title')
@lang('messages.update') @lang('messages.student')
@endsection
@section('content')
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title ">@lang('messages.update') @lang('messages.student')</h2>
                    <form action="{{route('admin.student_manage.update',['student_manage' => $student['id'] ])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" value="{{ $student['id'] }}">
                        <div class="mb-3 mt-4">
                            <label for="exampleInputText1" class="form-label">@lang('messages.name')</label>
                            <input type="text" class="form-control" id="exampleInputText1" name="name" value="{{$student['name']}}" placeholder="@lang('messages.enter') @lang('messages.name')">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" required class="form-control" id="exampleInputText1" name="username" value="{{$student['username']}}" placeholder="@lang('messages.enter') @lang('messages.username')">
                            @error('username')
                                <div class="alert alert-danger"> {{$message}} </div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" required class="form-control" id="exampleInputEmail3" name='email' value="{{$student['email']}}" placeholder="@lang('messages.enter') @lang('messages.email')">
                            @error('email')
                                <div class="alert alert-danger"> {{$message}} </div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputText1" name="phone" value="{{$student['phone']}}" placeholder="@lang('messages.enter') @lang('messages.phone')">
                            @error('phone')
                                <div class="alert alert-danger"> {{$message}} </div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputText1" name="address" value="{{$student['address']}}" placeholder="@lang('messages.enter') @lang('messages.adderss')">
                            @error('address')
                                <div class="alert alert-danger"> {{$message}} </div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputText1" name="city" value="{{$student['city']}}" placeholder="@lang('messages.enter') @lang('messages.city')">
                            @error('city')
                                <div class="alert alert-danger"> {{$message}} </div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 mx-4">
                            <img width="100" height="100" class=" rounded-circle" id="simage" src="{{!(empty($student['photo'])) ? url("storage/images/students/".$student['photo']) : url("images/admins/no_image.jpg")}}" alt="profile image">
                        </div>
