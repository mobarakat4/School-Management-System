...
@section('title')
@lang('messages.add') @lang('messages.teacher')
@endsection
@section('content')
...
<div class="page-content perfect-scrollbar-example">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title ">@lang('messages.add') @lang('messages.teacher')</h2>
                    <form action="{{route('admin.teacher_manage.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 mt-4">
                        ...
                        <div class="mb-3 mx-4">
                            <img width="100" height="100" class="rounded-circle" id="simage" src="{{ url("images/admins/no_image.jpg")}}" alt="profile image">
                        </div>
